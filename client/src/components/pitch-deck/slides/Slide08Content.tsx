      ...
      <div className="grid grid-cols-2 gap-10 mt-4 flex-1">
        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3 mt-4">
            ...
            >
              <img src={storePhoto} alt="Clayton at State & Liberty Store" className="w-full h-56 object-cover object-top" />
            </motion.div>
            <motion.div
              className="rounded-lg overflow-hidden border-2 border-white/20"
              initial={{ opacity: 0, scale: 0.9 }}
            ...
            >
              <img src={boatPhoto} alt="Clayton on Boat" className="w-full h-56 object-cover object-top" />
            </motion.div>
          </div>
        </motion.div>
